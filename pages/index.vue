    ...
    <v-flex xs12 sm8 md6>
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <p class="mb-0">
            <v-icon small>fiber_manual_record</v-icon>
            Download poster yang telah disediakan <nuxt-link to="/poster">di sini</nuxt-link>, kemudian upload di instagram kamu dengan caption berikut, lalu tag akun Future Leader Summit @FLSummit dan 5 teman kamu!
          </p>
